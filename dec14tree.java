...
/*Printar trädet i terminalen */

public class dec14tree {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for(int[] array : robots) updatePos(array, 7492);
        ...
        for(int y = 0; y < robotMap[0].length; y++){
            for(int x = 0; x < robotMap.length; x++){
                if(robotMap[x][y] == 0) System.out.print(".");
